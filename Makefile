.PHONY: help bootstrap mac-bootstrap mac-build-ghostty mac-generate mac-build mac-build-cli mac-run-app mac-format mac-lint mac-check mac-test mac-clean \
  mac-skill-version mac-skill-validate mac-skill-golden-update
...
mac-bootstrap mac-build-ghostty mac-generate mac-build mac-build-cli mac-run-app mac-format mac-lint mac-check mac-test mac-clean mac-skill-version mac-skill-validate mac-skill-golden-update:
