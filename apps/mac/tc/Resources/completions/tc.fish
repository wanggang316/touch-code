...
function __tc_parse_tokens -S
    ...
    case 'tc'
        ...
        case 'launch'
            __tc_parse_subcommand 0 'json' 'socket=' 'timeout=' 'wait=' 'app=' 'version' 'h/help'
        case 'doctor'
            __tc_parse_subcommand 0 'json' 'socket=' 'timeout=' 'version' 'h/help'
        case 'completion'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'completion' -d 'Print shell completion script for bash, zsh, or fish.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'ls' -d 'List projects, worktrees, tabs, and panes.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'project' -d 'List, create, and remove projects.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'worktree' -d 'List, create, switch, and remove worktrees.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'tab' -d 'List, create, switch, and close tabs.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'pane' -d 'List, create, focus, close, and label panes.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'send' -d 'Send text to a pane.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc" 1' -fa 'rpc' -d 'Low-level: call one raw RPC method.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc launch" socket' -l 'socket' -d 'Override the socket path (default: $TOUCH_CODE_SOCKET_PATH → /tmp/touch-code-<uid>.sock).' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc launch" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc launch" app' -l 'app' -d 'Bundle name to pass to `open -ga`.' -rfka ''
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc completion" version' -l 'version' -d 'Show the version.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc completion" h help' -s 'h' -l 'help' -d 'Show help information.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc ls" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc ls" socket' -l 'socket' -d 'Override the socket path (default: $TOUCH_CODE_SOCKET_PATH → /tmp/touch-code-<uid>.sock).' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc ls" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc ls" project' -l 'project' -d 'Restrict output to one project id, name, or \'current\'.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc ls" version' -l 'version' -d 'Show the version.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc ls" h help' -s 'h' -l 'help' -d 'Show help information.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc project" 1' -fa 'list' -d 'List projects.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc worktree" 1' -fa 'list' -d 'List worktrees for a project.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc worktree list" project' -l 'project' -d 'Project id, name, or \'current\'.' -rfka ''
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc tab" 1' -fa 'list' -d 'List tabs for a worktree.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc tab list" project' -l 'project' -d 'Project id, name, or \'current\'.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc tab list" worktree' -l 'worktree' -d 'Worktree id or \'current\'.' -rfka ''
...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc pane" 1' -fa 'list' -d 'List panes for a tab.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc pane list" project' -l 'project' -d 'Project id, name, or \'current\'.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc pane list" worktree' -l 'worktree' -d 'Worktree id or \'current\'.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc pane list" tab' -l 'tab' -d 'Tab id or \'current\'.' -rfka ''
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc send" p pane' -s 'p' -l 'pane' -d 'Target pane id, @label, or \'current\'.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc send" stdin' -l 'stdin' -d 'Read text from stdin.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc send" no-enter' -l 'no-enter' -d 'Do not send trailing Enter after text.'
