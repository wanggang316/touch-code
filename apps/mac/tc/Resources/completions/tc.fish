...
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc panel" 1' -fa 'list' -d 'List panels in a tab.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc panel" 1' -fa 'close' -d 'Close a panel.'
complete -c 'tc' -n '__tc_should_offer_completions_for_positional "tc panel" 1' -fa 'focus' -d 'Focus a panel within its tab.'
...
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" socket' -l 'socket' -d 'Override the socket path (default: $TOUCH_CODE_SOCKET_PATH → /tmp/touch-code-<uid>.sock).' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" space' -l 'space' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" project' -l 'project' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" worktree' -l 'worktree' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" tab' -l 'tab' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" version' -l 'version' -d 'Show the version.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel list" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" socket' -l 'socket' -d 'Override the socket path (default: $TOUCH_CODE_SOCKET_PATH → /tmp/touch-code-<uid>.sock).' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" space' -l 'space' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" project' -l 'project' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" worktree' -l 'worktree' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" tab' -l 'tab' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" version' -l 'version' -d 'Show the version.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel close" h help' -s 'h' -l 'help' -d 'Show help information.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" json' -l 'json' -d 'Emit JSON on stdout instead of human-readable text.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" socket' -l 'socket' -d 'Override the socket path (default: $TOUCH_CODE_SOCKET_PATH → /tmp/touch-code-<uid>.sock).' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" timeout' -l 'timeout' -d 'Client-side timeout in seconds for a single unary call.' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" space' -l 'space' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" project' -l 'project' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" worktree' -l 'worktree' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" tab' -l 'tab' -rfka ''
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" version' -l 'version' -d 'Show the version.'
complete -c 'tc' -n '__tc_should_offer_completions_for_flags_or_options "tc panel focus" h help' -s 'h' -l 'help' -d 'Show help information.'
