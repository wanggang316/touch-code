...
- [x] M6 — GitHub Actions release workflow on tag — 2026-05-05 (run #25369709068 produced draft release v0.1.0 with TouchCode-0.1.0.dmg + .sha256 attached; ~21 min cold)
